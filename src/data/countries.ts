...
// Sorted alphabetically by French name (Canada and the USA both use +1 but
// stay two distinct entries with their own name/flag — a shared dial code
// is normal, e.g. Russia/Kazakhstan both use +7).
const rawCountryDialCodes: CountryDialCode[] = [
  ...
  { name: 'Dominique', iso2: 'DM', dialCode: '1767' },
  ...
  { name: 'Grenade', iso2: 'GD', dialCode: '1473' },
...
export const countryDialCodes: CountryDialCode[] = [...rawCountryDialCodes].sort((a, b) => a.name.localeCompare(b.name, 'fr'));

export const DEFAULT_COUNTRY = countryDialCodes.find((c) => c.iso2 === 'SN')!;
