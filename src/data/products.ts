...
export interface Product {
  id: string; name: string; shopId: string; category: CategoryId; subcategory: string;
...
const D = 'Livraison à Dakar · 24–48 h';
const P4 = 'Retrait en boutique · À partir de 4 h';

export const products: Product[] = [
  // === VÊTEMENTS — Femme ===
  { id: 'robe-longue-satinee', name: 'Robe longue satinée', shopId: 'maison-fatou', category: 'vetements', subcategory: 'femme', gender: 'femme', price: 29900, oldPrice: 35000, images: [I.dress1, I.dress3, I.dress5, I.dress10], rating: 4.8, reviewCount: 24, stock: 6, variants: [{ name: 'Couleur', values: ['Noir', 'Bordeaux', 'Ivoire'] }, { name: 'Taille', values: ['S', 'M', 'L', 'XL'] }], description: 'Robe longue en satin fluide, coupe drapée à la taille. Tombé élégant pour vos soirées et cérémonies.', details: [{ label: 'Matière', value: 'Satin polyester' }, { label: 'Coupe', value: 'Longue, drapée' }, { label: 'Style', value: 'Mode moderne' }, { label: 'Type', value: 'Robe' }, { label: 'Entretien', value: 'Lavage à main' }], delivery: D, pickup: P4, isTrending: true, isPromo: true, reviews: [r('r1', 'Awa D.', 5, '2026-07-12', 'Robe magnifique, satin de très belle qualité.', true), r('r2', 'Fatou S.', 4, '2026-06-28', 'Très jolie robe, couleur fidèle.')] },
  { id: 'ensemble-femme-moderne', name: 'Ensemble femme moderne', shopId: 'maison-fatou', category: 'vetements', subcategory: 'femme', gender: 'femme', price: 35000, images: [I.dress4, I.dress2], rating: 4.7, reviewCount: 18, stock: 4, variants: [{ name: 'Couleur', values: ['Terracotta', 'Noir', 'Sable'] }, { name: 'Taille', values: ['S', 'M', 'L'] }], description: 'Ensemble deux pièces : top fluide et pantalon taille haute.', details: [{ label: 'Composition', value: 'Top + Pantalon' }, { label: 'Matière', value: 'Viscose' }, { label: 'Style', value: 'Mode moderne' }, { label: 'Type', value: 'Ensemble' }], delivery: D, pickup: P4, isTrending: true, reviews: [r('r3', 'Mariama B.', 5, '2026-07-01', 'Super ensemble, parfait pour le bureau.')] },
  { id: 'robe-wax-contemporaine', name: 'Robe wax contemporaine', shopId: 'maison-fatou', category: 'vetements', subcategory: 'femme', gender: 'femme', price: 28000, images: [I.dress5, I.dress1, I.dress12, I.dress11], rating: 4.9, reviewCount: 31, stock: 2, variants: [{ name: 'Taille', values: ['S', 'M', 'L', 'XL'] }], description: 'Robe en wax authentique, coupe contemporaine.', details: [{ label: 'Matière', value: 'Coton wax' }, { label: 'Origine', value: 'Tissu local' }, { label: 'Style', value: 'Mode africaine' }, { label: 'Type', value: 'Robe' }], delivery: D, isNew: true, reviews: [r('r4', 'Ndeye K.', 5, '2026-08-02', 'Wax de qualité, couture impeccable.', true)] },
  { id: 'robe-courte-elegante', name: 'Robe courte élégante', shopId: 'maison-fatou', category: 'vetements', subcategory: 'femme', gender: 'femme', price: 19500, images: [I.dress6, I.dress8], rating: 4.5, reviewCount: 12, stock: 7, variants: [{ name: 'Couleur', values: ['Noir', 'Rouge', 'Bleu marine'] }, { name: 'Taille', values: ['XS', 'S', 'M', 'L'] }], description: 'Robe courte cintrée, parfaite pour les sorties.', details: [{ label: 'Matière', value: 'Coton mélangé' }, { label: 'Style', value: 'Mode moderne' }, { label: 'Type', value: 'Robe' }], delivery: D, pickup: P4, isNew: true, reviews: [r('r22', 'Ndèye F.', 4, '2026-08-10', 'Belle coupe, bien taillée.')] },
  { id: 'combinaison-femme-soiree', name: 'Combinaison femme soirée', shopId: 'maison-fatou', category: 'vetements', subcategory: 'femme', gender: 'femme', price: 27000, images: [I.dress7, I.dress9], rating: 4.6, reviewCount: 9, stock: 5, variants: [{ name: 'Couleur', values: ['Bordeaux', 'Noir', 'Vert émeraude'] }, { name: 'Taille', values: ['S', 'M', 'L', 'XL'] }], description: 'Combinaison fluide pour soirées et événements.', details: [{ label: 'Matière', value: 'Viscose' }, { label: 'Style', value: 'Mode moderne' }, { label: 'Type', value: 'Combinaison' }], delivery: D, pickup: P4, isTrending: true, reviews: [r('r23', 'Aïssatou B.', 5, '2026-07-28', 'Combinaison superbe, tombe parfaitement.')] },
  { id: 'blazer-femme-tailleur', name: 'Blazer femme tailleur', shopId: 'maison-fatou', category: 'vetements', subcategory: 'femme', gender: 'femme', price: 32000, images: [I.dress8, I.dress6], rating: 4.7, reviewCount: 8, stock: 3, variants: [{ name: 'Couleur', values: ['Noir', 'Camel', 'Gris'] }, { name: 'Taille', values: ['S', 'M', 'L', 'XL'] }], description: 'Blazer structuré, coupe oversize tendance.', details: [{ label: 'Matière', value: 'Polyester lourd' }, { label: 'Style', value: 'Mode moderne' }, { label: 'Type', value: 'Blazer' }], delivery: D, isNew: true, reviews: [r('r24', 'Fama N.', 5, '2026-08-15', 'Blazer impeccable, parfait pour le bureau.')] },
  { id: 'ensemble-mode-modeste', name: 'Ensemble mode modeste', shopId: 'maison-fatou', category: 'vetements', subcategory: 'femme', gender: 'femme', price: 26000, images: [I.dress9, I.dress7], rating: 4.8, reviewCount: 14, stock: 6, variants: [{ name: 'Couleur', values: ['Sable', 'Ivoire', 'Vert sauge'] }, { name: 'Taille', values: ['S', 'M', 'L', 'XL', 'XXL'] }], description: 'Ensemble long fluide, coupe modeste et élégante.', details: [{ label: 'Matière', value: 'Crêpe' }, { label: 'Style', value: 'Mode modeste' }, { label: 'Type', value: 'Ensemble' }], delivery: D, pickup: P4, reviews: [r('r25', 'Sokhna D.', 5, '2026-07-30', 'Superbe ensemble, parfait pour mes valeurs.')] },

  // === VÊTEMENTS — Homme ===
  { id: 'chemise-homme-wax', name: 'Chemise homme wax', shopId: 'maison-fatou', category: 'vetements', subcategory: 'homme', gender: 'homme', price: 22000, images: [I.homme1, I.homme2], rating: 4.6, reviewCount: 16, stock: 8, variants: [{ name: 'Taille', values: ['S', 'M', 'L', 'XL', 'XXL'] }], description: 'Chemise en wax, coupe moderne.', details: [{ label: 'Matière', value: 'Coton wax' }, { label: 'Style', value: 'Mode africaine' }, { label: 'Type', value: 'Chemise' }], delivery: D, isNew: true, reviews: [r('r26', 'Moussa D.', 5, '2026-08-01', 'Chemise belle et bien coupée.')] },
  { id: 'boubou-homme-elegant', name: 'Boubou homme élégant', shopId: 'maison-fatou', category: 'vetements', subcategory: 'homme', gender: 'homme', price: 38000, images: [I.homme2, I.homme3, I.homme4, I.homme5], rating: 4.9, reviewCount: 11, stock: 4, variants: [{ name: 'Couleur', values: ['Blanc', 'Bleu marine', 'Bordeaux'] }, { name: 'Taille', values: ['M', 'L', 'XL', 'XXL', '3XL'] }], description: 'Boubou traditionnel brodé, grande occasion.', details: [{ label: 'Matière', value: 'Coton brodé' }, { label: 'Style', value: 'Mode africaine' }, { label: 'Type', value: 'Boubou' }], delivery: D, isTrending: true, reviews: [r('r27', 'Ibrahima S.', 5, '2026-07-20', 'Boubou magnifique pour les cérémonies.')] },
  { id: 't-shirt-homme-premium', name: 'T-shirt homme premium', shopId: 'maison-fatou', category: 'vetements', subcategory: 'homme', gender: 'homme', price: 9500, images: [I.homme3, I.homme1], rating: 4.4, reviewCount: 22, stock: 20, variants: [{ name: 'Couleur', values: ['Noir', 'Blanc', 'Gris', 'Bleu marine'] }, { name: 'Taille', values: ['S', 'M', 'L', 'XL', 'XXL', '3XL'] }], description: 'T-shirt en coton peigné, coupe régulière.', details: [{ label: 'Matière', value: 'Coton peigné 180g' }, { label: 'Style', value: 'Mode moderne' }, { label: 'Type', value: 'T-shirt' }], delivery: D, reviews: [r('r28', 'Cheikh F.', 4, '2026-07-25', 'Bon t-shirt, tissu solide.')] },
  { id: 'pantalon-homme-chino', name: 'Pantalon homme chino', shopId: 'maison-fatou', category: 'vetements', subcategory: 'homme', gender: 'homme', price: 16500, oldPrice: 21000, images: [I.homme1, I.homme3], rating: 4.5, reviewCount: 18, stock: 10, variants: [{ name: 'Couleur', values: ['Beige', 'Noir', 'Bleu marine', 'Kaki'] }, { name: 'Taille', values: ['S', 'M', 'L', 'XL', 'XXL'] }], description: 'Pantalon chino stretch, coupe slim.', details: [{ label: 'Matière', value: 'Coton stretch' }, { label: 'Style', value: 'Mode moderne' }, { label: 'Type', value: 'Pantalon' }], delivery: D, isPromo: true, reviews: [r('r29', 'Omar S.', 4, '2026-07-18', 'Bon pantalon, taille bien.')] },

  // === CHAUSSURES — Femme ===
  { id: 'escarpins-talons-hauts', name: 'Escarpins talons hauts', shopId: 'maison-fatou', category: 'chaussures', subcategory: 'femme', shoeGender: 'femme', price: 21000, images: [I.shoe3, I.shoe1, I.shoe8, I.shoe10], rating: 4.5, reviewCount: 15, stock: 3, variants: [{ name: 'Couleur', values: ['Nude', 'Noir', 'Bleu'] }, { name: 'Taille', values: ['36', '37', '38', '39', '40', '41'] }], description: 'Escarpins élégants, talon 8 cm.', details: [{ label: 'Talon', value: '8 cm' }, { label: 'Type', value: 'Escarpins' }, { label: 'Matière', value: 'Cuir synthétique premium' }], delivery: D, isNew: true, reviews: [r('r8', 'Diariatou S.', 4, '2026-07-18', 'Très élégants, taille un peu grand.')] },
  { id: 'sandales-cuir-minimales', name: 'Sandales en cuir minimales', shopId: 'atelier-naya', category: 'chaussures', subcategory: 'femme', shoeGender: 'femme', price: 16500, images: [I.shoe1, I.shoe4], rating: 4.8, reviewCount: 22, stock: 10, variants: [{ name: 'Couleur', values: ['Camel', 'Noir'] }, { name: 'Taille', values: ['36', '37', '38', '39', '40'] }], description: 'Sandales fines en cuir, minimalistes.', details: [{ label: 'Matière', value: 'Cuir véritable' }, { label: 'Type', value: 'Sandales' }, { label: 'Semelle', value: 'Cuir' }], delivery: D, pickup: 'Retrait en atelier · À partir de 4 h', isTrending: true, reviews: [r('r9', 'Ndèye T.', 5, '2026-06-30', 'Confortables dès la première fois.')] },
  { id: 'baskets-femme-blanches', name: 'Baskets femme blanches', shopId: 'atelier-naya', category: 'chaussures', subcategory: 'femme', shoeGender: 'femme', price: 18500, images: [I.shoe5, I.shoe6], rating: 4.6, reviewCount: 28, stock: 12, variants: [{ name: 'Couleur', values: ['Blanc', 'Beige', 'Rose'] }, { name: 'Taille', values: ['36', '37', '38', '39', '40', '41'] }], description: 'Baskets légères, semelle confort.', details: [{ label: 'Type', value: 'Baskets' }, { label: 'Matière', value: 'Cuir' }], delivery: D, isNew: true, reviews: [r('r30', 'Awa M.', 5, '2026-08-08', 'Baskets superbes, très confortables.')] },
  { id: 'mules-femme-cuir', name: 'Mules femme en cuir', shopId: 'atelier-naya', category: 'chaussures', subcategory: 'femme', shoeGender: 'femme', price: 14000, oldPrice: 17000, images: [I.shoe4, I.shoe1], rating: 4.4, reviewCount: 10, stock: 6, variants: [{ name: 'Couleur', values: ['Marron', 'Noir', 'Cognac'] }, { name: 'Taille', values: ['36', '37', '38', '39', '40'] }], description: 'Mules en cuir, faciles à porter.', details: [{ label: 'Type', value: 'Mules' }, { label: 'Matière', value: 'Cuir véritable' }], delivery: D, pickup: 'Retrait en atelier · À partir de 4 h', isPromo: true, reviews: [r('r31', 'Mariama S.', 4, '2026-07-22', 'Mules pratiques et jolies.')] },

  // === CHAUSSURES — Homme ===
  { id: 'sneakers-homme-cuir', name: 'Sneakers homme cuir', shopId: 'atelier-naya', category: 'chaussures', subcategory: 'homme', shoeGender: 'homme', price: 24500, images: [I.shoe6, I.shoe5], rating: 4.7, reviewCount: 19, stock: 8, variants: [{ name: 'Couleur', values: ['Blanc', 'Noir', 'Gris'] }, { name: 'Taille', values: ['40', '41', '42', '43', '44', '45'] }], description: 'Sneakers en cuir, style minimaliste.', details: [{ label: 'Type', value: 'Sneakers' }, { label: 'Matière', value: 'Cuir véritable' }], delivery: D, pickup: 'Retrait en atelier · À partir de 4 h', isTrending: true, reviews: [r('r32', 'Babacar N.', 5, '2026-07-15', 'Sneakers propres et solides.')] },
  { id: 'mocassins-homme-classique', name: 'Mocassins homme classique', shopId: 'atelier-naya', category: 'chaussures', subcategory: 'homme', shoeGender: 'homme', price: 22000, images: [I.shoe7, I.shoe6], rating: 4.5, reviewCount: 12, stock: 5, variants: [{ name: 'Couleur', values: ['Marron', 'Noir'] }, { name: 'Taille', values: ['40', '41', '42', '43', '44'] }], description: 'Mocassins en cuir, coupe classique.', details: [{ label: 'Type', value: 'Mocassins' }, { label: 'Matière', value: 'Cuir véritable' }], delivery: D, isNew: true, reviews: [r('r33', 'Modou F.', 4, '2026-08-05', 'Bons mocassins, cuir de qualité.')] },
  { id: 'baskets-homme-sport', name: 'Baskets homme sport', shopId: 'maison-fatou', category: 'chaussures', subcategory: 'homme', shoeGender: 'homme', price: 19500, oldPrice: 25000, images: [I.shoe5, I.shoe7], rating: 4.3, reviewCount: 25, stock: 15, variants: [{ name: 'Couleur', values: ['Noir', 'Bleu marine', 'Gris'] }, { name: 'Taille', values: ['40', '41', '42', '43', '44', '45'] }], description: 'Baskets sport, semelle amortie.', details: [{ label: 'Type', value: 'Baskets' }, { label: 'Matière', value: 'Mesh + synthétique' }], delivery: D, isPromo: true, reviews: [r('r34', 'Pape D.', 4, '2026-07-12', 'Légères et confortables pour le sport.')] },

  // === SACS & MAROQUINERIE ===
  { id: 'sac-a-main-structure', name: 'Sac à main structuré', shopId: 'atelier-naya', category: 'sacs', subcategory: 'sacs-a-main', price: 24900, images: [I.bag1, I.bag3, I.bag7, I.bag8], rating: 4.7, reviewCount: 42, stock: 8, variants: [{ name: 'Couleur', values: ['Camel', 'Noir', 'Cognac'] }], description: 'Sac structuré en cuir véritable, format moyen.', details: [{ label: 'Matière', value: 'Cuir véritable' }, { label: 'Type', value: 'Sac à main' }, { label: 'Dimensions', value: '28 × 20 × 12 cm' }], delivery: D, pickup: 'Retrait en atelier · À partir de 4 h', isTrending: true, reviews: [r('r5', 'Sokhna A.', 5, '2026-07-20', 'Cuir souple, finitions parfaites.'), r('r6', 'Aïcha M.', 4, '2026-06-15', 'Beau sac, juste un peu plus petit que prévu.')] },
  { id: 'sac-bandouliere-cuir', name: 'Sac bandoulière en cuir', shopId: 'atelier-naya', category: 'sacs', subcategory: 'sacs-bandouliere', price: 18500, oldPrice: 22000, images: [I.bag2, I.bag4], rating: 4.6, reviewCount: 27, stock: 5, variants: [{ name: 'Couleur', values: ['Noir', 'Beige', 'Marron'] }], description: 'Sac bandoulière compact, lanière réglable.', details: [{ label: 'Matière', value: 'Cuir véritable' }, { label: 'Type', value: 'Sac bandoulière' }, { label: 'Dimensions', value: '22 × 15 × 6 cm' }], delivery: D, pickup: 'Retrait en atelier · À partir de 4 h', isPromo: true, reviews: [r('r7', 'Coumba F.', 5, '2026-07-05', 'Parfait pour sortir.')] },
  { id: 'pochette-soiree-doree', name: 'Pochette de soirée dorée', shopId: 'atelier-naya', category: 'sacs', subcategory: 'pochette', price: 12000, images: [I.bag3, I.bag5], rating: 4.5, reviewCount: 15, stock: 9, variants: [{ name: 'Couleur', values: ['Doré', 'Noir', 'Argenté'] }], description: 'Pochette élégante pour vos soirées.', details: [{ label: 'Type', value: 'Pochette' }, { label: 'Matière', value: 'Simili cuir' }], delivery: D, isNew: true, reviews: [r('r35', 'Aminata F.', 5, '2026-08-12', 'Pochette magnifique, parfaite pour les events.')] },
  { id: 'portefeuille-cuir-homme', name: 'Portefeuille cuir homme', shopId: 'atelier-naya', category: 'sacs', subcategory: 'portefeuilles', price: 9500, images: [I.bag4, I.bag6], rating: 4.6, reviewCount: 20, stock: 14, variants: [{ name: 'Couleur', values: ['Marron', 'Noir', 'Cognac'] }], description: 'Portefeuille en cuir, 8 emplacements cartes.', details: [{ label: 'Type', value: 'Portefeuille' }, { label: 'Matière', value: 'Cuir véritable' }], delivery: D, pickup: 'Retrait en atelier · À partir de 4 h', isTrending: true, reviews: [r('r36', 'Serigne D.', 5, '2026-07-10', 'Portefeuille solide, belle finition.')] },
  { id: 'sac-a-dos-cuir-minimal', name: 'Sac à dos cuir minimal', shopId: 'atelier-naya', category: 'sacs', subcategory: 'sacs-a-dos', price: 28000, oldPrice: 34000, images: [I.bag6, I.bag1], rating: 4.7, reviewCount: 17, stock: 4, variants: [{ name: 'Couleur', values: ['Noir', 'Marron', 'Camel'] }], description: 'Sac à dos en cuir, design épuré.', details: [{ label: 'Type', value: 'Sac à dos' }, { label: 'Matière', value: 'Cuir véritable' }], delivery: D, isPromo: true, reviews: [r('r37', 'Ousmane B.', 5, '2026-07-25', 'Sac à dos élégant et pratique.')] },

  // === BEAUTÉ — Maquillage ===
  { id: 'palette-maquillage-nude', name: 'Palette maquillage nude', shopId: 'dakar-beauty', category: 'beaute', subcategory: 'maquillage', price: 19500, images: [I.makeup2, I.makeup1, I.makeup7, I.makeup6], rating: 4.7, reviewCount: 41, stock: 7, variants: [{ name: 'Teinte', values: ['Nude', 'Warm', 'Deep'] }], description: 'Palette 12 teintes, finis mats et satinés.', details: [{ label: 'Zone', value: 'Yeux' }, { label: 'Type', value: 'Palette' }, { label: 'Teintes', value: '12' }, { label: 'Fini', value: 'Mat, Satiné' }], delivery: D, isNew: true, reviews: [r('r13', 'Rokhya N.', 5, '2026-08-01', 'Pigmentation superbe.')] },
  { id: 'rouge-a-levres-mat', name: 'Rouge à lèvres mat', shopId: 'dakar-beauty', category: 'beaute', subcategory: 'maquillage', price: 8500, images: [I.makeup1, I.makeup3], rating: 4.5, reviewCount: 29, stock: 20, variants: [{ name: 'Teinte', values: ['Brick', 'Rose nude', 'Prune', 'Rouge'] }], description: 'Rouge à lèvres mat longue tenue.', details: [{ label: 'Zone', value: 'Lèvres' }, { label: 'Type', value: 'Rouge à lèvres' }, { label: 'Fini', value: 'Mat' }, { label: 'Tenue', value: '8 h' }], delivery: D, reviews: [r('r14', 'Awa S.', 4, '2026-07-08', 'Belle tenue, couleur Brick superbe.')] },
  { id: 'fond-de-teint-veloute', name: 'Fond de teint velouté', shopId: 'dakar-beauty', category: 'beaute', subcategory: 'maquillage', price: 14500, images: [I.makeup4, I.makeup1, I.makeup8, I.makeup6], rating: 4.6, reviewCount: 35, stock: 11, variants: [{ name: 'Teinte', values: ['Café', 'Moka', 'Caramel', 'Noisette'] }], description: 'Fond de teint couvrance modulable, fini velouté.', details: [{ label: 'Zone', value: 'Teint' }, { label: 'Type', value: 'Fond de teint' }, { label: 'Fini', value: 'Velouté' }], delivery: D, isTrending: true, reviews: [r('r38', 'Mame S.', 5, '2026-07-28', 'Couvrance parfaite pour ma peau.')] },
  { id: 'mascara-volume-intense', name: 'Mascara volume intense', shopId: 'dakar-beauty', category: 'beaute', subcategory: 'maquillage', price: 7500, images: [I.makeup5, I.makeup3], rating: 4.4, reviewCount: 18, stock: 16, variants: [], description: 'Mascara allonge et densifie les cils.', details: [{ label: 'Zone', value: 'Yeux' }, { label: 'Type', value: 'Mascara' }, { label: 'Fini', value: 'Intense' }], delivery: D, isNew: true, reviews: [r('r39', 'Fatou D.', 4, '2026-08-06', 'Bon mascara, pas de paquets.')] },
  { id: 'gloss-levres-brillant', name: 'Gloss lèvres brillant', shopId: 'dakar-beauty', category: 'beaute', subcategory: 'maquillage', price: 6500, images: [I.makeup3, I.makeup5], rating: 4.3, reviewCount: 14, stock: 18, variants: [{ name: 'Teinte', values: ['Transparent', 'Rose nude', 'Corail'] }], description: 'Gloss hydratant, effet miroir non collant.', details: [{ label: 'Zone', value: 'Lèvres' }, { label: 'Type', value: 'Gloss' }, { label: 'Fini', value: 'Brillant' }], delivery: D, reviews: [r('r40', 'Aïda N.', 4, '2026-07-19', 'Gloss joli, pas trop collant.')] },

  // === BEAUTÉ — Skincare ===
  { id: 'serum-hydratant-visage', name: 'Sérum hydratant visage', shopId: 'dakar-beauty', category: 'beaute', subcategory: 'skincare', price: 12500, images: [I.skincare1, I.skincare3, I.skincare7, I.skincare8], rating: 4.9, reviewCount: 58, stock: 14, variants: [{ name: 'Contenance', values: ['30 ml', '50 ml'] }], variantPrices: [{ conditions: { Contenance: '30 ml' }, price: 9500 }, { conditions: { Contenance: '50 ml' }, price: 12500 }], description: 'Sérum à l\'acide hyaluronique et vitamine E.', details: [{ label: 'Type de peau', value: 'Sèche, sensible' }, { label: 'Besoin', value: 'Hydratation' }, { label: 'Type de produit', value: 'Sérum' }, { label: 'Contenance', value: '50 ml' }], delivery: D, isTrending: true, reviews: [r('r10', 'Aminata D.', 5, '2026-07-22', 'Ma peau a changé en deux semaines.', true), r('r11', 'Khady S.', 5, '2026-07-10', 'Excellent sérum, pénètre vite.')] },
  { id: 'creme-anti-imperfections', name: 'Crème anti-imperfections', shopId: 'dakar-beauty', category: 'beaute', subcategory: 'skincare', price: 14000, oldPrice: 17500, images: [I.skincare2, I.skincare4, I.skincare9, I.skincare7], rating: 4.6, reviewCount: 34, stock: 9, variants: [{ name: 'Contenance', values: ['40 ml'] }], description: 'Crème légère à la niacinamide.', details: [{ label: 'Type de peau', value: 'Mixte, grasse' }, { label: 'Besoin', value: 'Imperfections' }, { label: 'Type de produit', value: 'Crème' }], delivery: D, isPromo: true, reviews: [r('r12', 'Yacine B.', 4, '2026-07-15', 'Bonne crème, imperfections réduites.')] },
  { id: 'nettoyant-gel-doux', name: 'Nettoyant gel doux', shopId: 'dakar-beauty', category: 'beaute', subcategory: 'skincare', price: 8500, images: [I.skincare5, I.skincare1], rating: 4.7, reviewCount: 26, stock: 12, variants: [{ name: 'Contenance', values: ['150 ml', '250 ml'] }], variantPrices: [{ conditions: { Contenance: '150 ml' }, price: 8500 }, { conditions: { Contenance: '250 ml' }, price: 12000 }], description: 'Gel nettoyant doux, sans savon, pour tous types de peau.', details: [{ label: 'Type de peau', value: 'Normale, sensible' }, { label: 'Besoin', value: 'Nettoyage' }, { label: 'Type de produit', value: 'Nettoyant' }], delivery: D, isNew: true, reviews: [r('r41', 'Ndèye M.', 5, '2026-08-09', 'Nettoyant doux, ne dessèche pas.')] },
  { id: 'masque-eclat-argile', name: 'Masque éclat à l\'argile', shopId: 'dakar-beauty', category: 'beaute', subcategory: 'skincare', price: 11000, images: [I.skincare6, I.skincare3], rating: 4.5, reviewCount: 19, stock: 8, variants: [{ name: 'Contenance', values: ['100 ml'] }], description: 'Masque purifiant à l\'argile verte, affiné les pores.', details: [{ label: 'Type de peau', value: 'Mixte, grasse' }, { label: 'Besoin', value: 'Texture / pores' }, { label: 'Type de produit', value: 'Masque' }], delivery: D, reviews: [r('r42', 'Awa B.', 4, '2026-07-14', 'Bon masque, peau nette après.')] },
  { id: 'creme-solaire-visage', name: 'Crème solaire visage SPF50', shopId: 'dakar-beauty', category: 'beaute', subcategory: 'skincare', price: 13500, images: [I.skincare4, I.skincare5], rating: 4.8, reviewCount: 31, stock: 10, variants: [{ name: 'Contenance', values: ['50 ml'] }], description: 'Protection solaire SPF50, fini invisible, sans traces blanches.', details: [{ label: 'Type de peau', value: 'Toutes' }, { label: 'Besoin', value: 'Hydratation' }, { label: 'Type de produit', value: 'SPF' }], delivery: D, isTrending: true, reviews: [r('r43', 'Mariama K.', 5, '2026-08-03', 'SPF invisible, fini top.')] },

  // === BEAUTÉ — Soins capillaires ===
  { id: 'huile-cheveux-pousse', name: 'Huile cheveux pousse', shopId: 'dakar-beauty', category: 'beaute', subcategory: 'soins-capillaires', price: 9500, images: [I.skincare5, I.hair5], rating: 4.6, reviewCount: 24, stock: 13, variants: [{ name: 'Contenance', values: ['60 ml', '100 ml'] }], variantPrices: [{ conditions: { Contenance: '60 ml' }, price: 9500 }, { conditions: { Contenance: '100 ml' }, price: 14000 }], description: 'Huile fortifiante pour stimuler la pousse.', details: [{ label: 'Besoin', value: 'Pousse, Anti-chute' }, { label: 'Type de produit', value: 'Huile' }], delivery: D, isTrending: true, reviews: [r('r44', 'Fama S.', 5, '2026-07-20', 'Mes cheveux ont poussé !')] },
  { id: 'shampooing-hydratant', name: 'Shampooing hydratant', shopId: 'dakar-beauty', category: 'beaute', subcategory: 'soins-capillaires', price: 7000, images: [I.skincare6, I.hair6], rating: 4.4, reviewCount: 16, stock: 15, variants: [{ name: 'Contenance', values: ['250 ml', '500 ml'] }], variantPrices: [{ conditions: { Contenance: '250 ml' }, price: 7000 }, { conditions: { Contenance: '500 ml' }, price: 11000 }], description: 'Shampooing sans sulfates, hydrate les cheveux secs.', details: [{ label: 'Besoin', value: 'Hydratation' }, { label: 'Type de produit', value: 'Shampooing' }], delivery: D, reviews: [r('r45', 'Khady D.', 4, '2026-07-11', 'Bon shampooing, cheveux doux.')] },

  // === BEAUTÉ — Hygiène ===
  { id: 'gel-douche-hydratant', name: 'Gel douche hydratant', shopId: 'dakar-beauty', category: 'beaute', subcategory: 'hygiene', price: 5500, images: [I.skincare5, I.skincare6], rating: 4.5, reviewCount: 20, stock: 18, variants: [{ name: 'Contenance', values: ['300 ml', '500 ml'] }], variantPrices: [{ conditions: { Contenance: '300 ml' }, price: 5500 }, { conditions: { Contenance: '500 ml' }, price: 8000 }], description: 'Gel douche doux, senteur fleur de tiaré.', details: [{ label: 'Besoin', value: 'Nettoyage, Hydratation' }, { label: 'Type de produit', value: 'Gel douche' }], delivery: D, reviews: [r('r46', 'Astou M.', 4, '2026-07-25', 'Bonne odeur, peau douce.')] },
  { id: 'deodorant-naturel', name: 'Déodorant naturel', shopId: 'dakar-beauty', category: 'beaute', subcategory: 'hygiene', price: 6500, images: [I.skincare6, I.skincare1], rating: 4.3, reviewCount: 12, stock: 10, variants: [{ name: 'Parfum', values: ['Citron', 'Lavande', 'Sans parfum'] }], description: 'Déodorant sans aluminium, 24h d\'efficacité.', details: [{ label: 'Besoin', value: 'Déodorant' }], delivery: D, isNew: true, reviews: [r('r47', 'Ndèye F.', 4, '2026-08-07', 'Déodorant efficace, naturel.')] },

  // === CHEVEUX — Perruques ===
  { id: 'perruque-body-wave-22', name: 'Perruque Body Wave 22"', shopId: 'hair-studio-dakar', category: 'cheveux', subcategory: 'perruques', texture: 'Body Wave', hairMaterial: 'Romance', price: 85000, oldPrice: 95000, images: [I.hair1, I.hair3, I.hair7, I.hair8], rating: 4.8, reviewCount: 36, stock: 4, variants: [{ name: 'Longueur', values: ['16"', '18"', '20"', '22"'] }, { name: 'Densité', values: ['150%', '180%', '200%'] }, { name: 'Couleur', values: ['Noir naturel', 'Brun', 'Chocolat'] }], variantPrices: [
  ...
  { id: 'perruque-straight-20', name: 'Perruque Straight 20"', shopId: 'hair-studio-dakar', category: 'cheveux', subcategory: 'perruques', texture: 'Straight', hairMaterial: 'Cheveux vietnamiens', price: 78000, images: [I.hair3, I.hair1, I.hair9, I.hair10], rating: 4.7, reviewCount: 21, stock: 3, variants: [{ name: 'Longueur', values: ['14"', '16"', '18"', '20"'] }, { name: 'Densité', values: ['150%', '180%', '200%'] }, { name: 'Couleur', values: ['Noir naturel', 'Noir', 'Brun foncé'] }], variantPrices: [
    { conditions: { Longueur: '14"', Densité: '150%' }, price: 48000 },
    { conditions: { Longueur: '14"', Densité: '180%' }, price: 52000 },
    { conditions: { Longueur: '14"', Densité: '200%' }, price: 58000 },
    { conditions: { Longueur: '16"', Densité: '150%' }, price: 58000 },
    { conditions: { Longueur: '16"', Densité: '180%' }, price: 62000 },
    { conditions: { Longueur: '16"', Densité: '200%' }, price: 68000 },
    { conditions: { Longueur: '18"', Densité: '150%' }, price: 68000 },
    { conditions: { Longueur: '18"', Densité: '180%' }, price: 72000 },
    { conditions: { Longueur: '18"', Densité: '200%' }, price: 78000 },
    { conditions: { Longueur: '20"', Densité: '150%' }, price: 75000 },
    { conditions: { Longueur: '20"', Densité: '180%' }, price: 78000 },
    { conditions: { Longueur: '20"', Densité: '200%' }, price: 85000 },
  ], description: 'Perruque lace droite, cheveux vietnamiens lisses.', details: [{ label: 'Type', value: 'Lace frontal' }, { label: 'Cheveux', value: 'Cheveux vietnamiens' }, { label: 'Texture', value: 'Straight' }, { label: 'Matière', value: 'Cheveux vietnamiens' }], delivery: D, pickup: 'Retrait en studio · À partir de 24 h', isTrending: true, reviews: [r('r48', 'Awa K.', 5, '2026-08-01', 'Cheveux soyeux, très belle qualité.')] },
  { id: 'perruque-curly-18', name: 'Perruque Curly 18"', shopId: 'hair-studio-dakar', category: 'cheveux', subcategory: 'perruques', texture: 'Curly', hairMaterial: 'Cheveux naturels', price: 72000, oldPrice: 80000, images: [I.hair4, I.hair2, I.hair8, I.hair9], rating: 4.6, reviewCount: 15, stock: 2, variants: [{ name: 'Longueur', values: ['14"', '16"', '18"'] }, { name: 'Densité', values: ['180%', '200%'] }, { name: 'Couleur', values: ['Noir naturel', 'Chocolat'] }], variantPrices: [
    { conditions: { Longueur: '14"', Densité: '180%' }, price: 52000 },
    { conditions: { Longueur: '14"', Densité: '200%' }, price: 58000 },
    { conditions: { Longueur: '16"', Densité: '180%' }, price: 62000 },
    { conditions: { Longueur: '16"', Densité: '200%' }, price: 68000 },
    ...
    { conditions: { Longueur: '18"', Densité: '200%' }, price: 78000 },
  ], description: 'Perruque bouclée naturelle, lace frontale.', details: [{ label: 'Type', value: 'Lace frontal' }, { label: 'Cheveux', value: 'Cheveux naturels' }, { label: 'Texture', value: 'Curly' }, { label: 'Matière', value: 'Cheveux naturels' }], delivery: D, isPromo: true, reviews: [r('r49', 'Mariama D.', 5, '2026-07-28', 'Boucles superbes, look naturel.')] },
  ...
  // === CHEVEUX — Mèches ===
  { id: 'meches-naturelles-pre-tressees', name: 'Mèches naturelles pré-tressées', shopId: 'hair-studio-dakar', category: 'cheveux', subcategory: 'meches', texture: 'Straight', hairMaterial: 'Cheveux naturels', price: 32000, images: [I.hair2, I.hair4], rating: 4.6, reviewCount: 19, stock: 15, variants: [{ name: 'Longueur', values: ['24"', '28"', '32"'] }, { name: 'Couleur', values: ['Noir naturel', 'Brun', 'Châtain'] }], description: 'Mèches pré-tressées prêtes à poser.', details: [{ label: 'Quantité', value: '6 packs / tête' }, { label: 'Texture', value: 'Straight' }, { label: 'Matière', value: 'Cheveux naturels' }], delivery: D, reviews: [r('r17', 'Mame D.', 4, '2026-06-20', 'Bonne qualité, pose facile.')] },
  { id: 'meches-water-wave-28', name: 'Mèches Water Wave 28"', shopId: 'hair-studio-dakar', category: 'cheveux', subcategory: 'meches', texture: 'Water Wave', hairMaterial: 'Blend Hair', price: 28000, oldPrice: 35000, images: [I.hair4, I.hair2], rating: 4.5, reviewCount: 12, stock: 10, variants: [{ name: 'Longueur', values: ['24"', '28"', '32"'] }, { name: 'Couleur', values: ['Noir', 'Brun foncé'] }], description: 'Mèches water wave, effet plage.', details: [{ label: 'Quantité', value: '6 packs / tête' }, { label: 'Texture', value: 'Water Wave' }, { label: 'Matière', value: 'Blend Hair' }], delivery: D, isPromo: true, reviews: [r('r51', 'Aïda S.', 4, '2026-07-18', 'Belles boucles, bonne tenue.')] },

  // === CHEVEUX — Blend Hair ===
  { id: 'blend-hair-kinky-curly', name: 'Blend Hair Kinky Curly 16"', shopId: 'hair-studio-dakar', category: 'cheveux', subcategory: 'blend-hair', texture: 'Kinky Curly', hairMaterial: 'Blend Hair', price: 25000, images: [I.hair5, I.hair6], rating: 4.4, reviewCount: 8, stock: 7, variants: [{ name: 'Longueur', values: ['12"', '14"', '16"'] }, { name: 'Couleur', values: ['Noir naturel', 'Chocolat'] }], description: 'Blend hair kinky curly, texture afro naturelle.', details: [{ label: 'Texture', value: 'Kinky Curly' }, { label: 'Matière', value: 'Blend Hair' }], delivery: D, isNew: true, reviews: [r('r52', 'Ndèye A.', 4, '2026-08-05', 'Texture afro top.')] },

  // === CHEVEUX — Cheveux naturels ===
  { id: 'cheveux-naturels-bundle-raw', name: 'Bundle Raw Hair 3 pièces', shopId: 'hair-studio-dakar', category: 'cheveux', subcategory: 'cheveux-naturels', texture: 'Straight', hairMaterial: 'Raw Hair', price: 65000, images: [I.hair6, I.hair5], rating: 4.8, reviewCount: 22, stock: 5, variants: [{ name: 'Longueur', values: ['16"', '18"', '20"', '22"', '24"'] }, { name: 'Couleur', values: ['Noir naturel', 'Brun'] }], variantPrices: [
  ...
  // === PARFUMS — Femme ===
  { id: 'parfum-femme-100ml', name: 'Parfum femme Élégance', shopId: 'maison-senteur', category: 'parfums', subcategory: 'parfums-femme', price: 32000, images: [I.perfume1, I.perfume3, I.perfume7, I.perfume8], rating: 4.8, reviewCount: 47, stock: 11, variants: [{ name: 'Volume', values: ['30 ml', '50 ml', '100 ml'] }], variantPrices: [
  ...
  { id: 'parfum-femme-gourmand', name: 'Parfum femme Gourmand Vanille', shopId: 'maison-senteur', category: 'parfums', subcategory: 'parfums-femme', price: 28000, images: [I.perfume3, I.perfume1], rating: 4.7, reviewCount: 19, stock: 8, variants: [{ name: 'Volume', values: ['30 ml', '50 ml', '100 ml'] }], variantPrices: [
    { conditions: { Volume: '30 ml' }, price: 16000 },
    { conditions: { Volume: '50 ml' }, price: 22000 },
    { conditions: { Volume: '100 ml' }, price: 28000 },
  ], description: 'Parfum gourmand vanillé, chaleureux et sensuel.', details: [
    { label: 'Famille olfactive', value: 'Gourmand' }, { label: 'Tenue', value: '8 h' },
    { label: 'Notes de tête', value: 'Mandarine, prune' },
    { label: 'Notes de cœur', value: 'Vanille, fleur de tiaré' },
    { label: 'Notes de fond', value: 'Vanille bourbon, musc blanc' },
  ], delivery: D, isNew: true, reviews: [r('r54', 'Aminata S.', 5, '2026-08-08', 'Vanille magnifique.')] },

  // === PARFUMS — Homme ===
  { id: 'parfum-homme-boise', name: 'Parfum homme Boisé Intense', shopId: 'maison-senteur', category: 'parfums', subcategory: 'parfums-homme', price: 30000, images: [I.perfume5, I.perfume1, I.perfume9, I.perfume10], rating: 4.7, reviewCount: 25, stock: 9, variants: [{ name: 'Volume', values: ['50 ml', '100 ml'] }], variantPrices: [
    { conditions: { Volume: '50 ml' }, price: 22000 },
  ...
  { id: 'brume-parfumee-fleur', name: 'Brume parfumée fleur de tiaré', shopId: 'maison-senteur', category: 'parfums', subcategory: 'huiles-brumes', price: 9500, images: [I.perfume2, I.perfume4], rating: 4.7, reviewCount: 23, stock: 18, variants: [{ name: 'Volume', values: ['100 ml', '250 ml', '500 ml'] }], variantPrices: [
  ...
  { id: 'huile-parfumee-musk', name: 'Huile parfumée Musc Blanc', shopId: 'maison-senteur', category: 'parfums', subcategory: 'huiles-brumes', price: 12000, images: [I.perfume4, I.perfume2], rating: 4.6, reviewCount: 16, stock: 7, variants: [{ name: 'Volume', values: ['30 ml', '50 ml'] }], variantPrices: [
    { conditions: { Volume: '30 ml' }, price: 12000 },
    { conditions: { Volume: '50 ml' }, price: 17000 },
  ], description: 'Huile parfumée musc blanc, tenue longue.', details: [
    { label: 'Type', value: 'Huile parfumée' }, { label: 'Famille olfactive', value: 'Musqué' },
    { label: 'Notes', value: 'Musc blanc, fleur de coton' },
  ], delivery: D, isTrending: true, reviews: [r('r56', 'Fatou D.', 5, '2026-07-16', 'Musc doux et durable.')] },

  // === PARFUMS — Encens & Parfums de maison ===
  { id: 'encens-oud-premium', name: 'Encens oud premium', shopId: 'maison-senteur', category: 'parfums', subcategory: 'encens-parfums-maison', price: 7500, images: [I.encens1, I.perfume3], rating: 4.6, reviewCount: 12, stock: 0, variants: [{ name: 'Quantité', values: ['50g', '100g'] }], variantPrices: [
    { conditions: { Quantité: '50g' }, price: 7500 },
    { conditions: { Quantité: '100g' }, price: 13000 },
  ], description: 'Encens naturel au oud.', details: [
    { label: 'Senteur', value: 'Oud boisé' }, { label: 'Famille olfactive', value: 'Boisé' },
    { label: 'Notes', value: 'Oud, santal, ambre' },
  ], delivery: D, reviews: [] },
  { id: 'parfum-maison-amber', name: 'Parfum de maison Ambre & Santal', shopId: 'maison-senteur', category: 'parfums', subcategory: 'encens-parfums-maison', price: 15000, images: [I.perfume6, I.encens1], rating: 4.7, reviewCount: 14, stock: 6, variants: [{ name: 'Volume', values: ['100 ml', '250 ml'] }], variantPrices: [
