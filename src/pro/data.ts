...
export const products: Product[] = [
  { id: 'p1', name: 'Robe longue satinée - Bordeaux', shopId: 'maison-fatou', category: 'Vêtements', price: 29900, oldPrice: 35000, image: P_IMG.dress, stock: 6, status: 'published', variants: [{ name: 'Couleur', values: ['Noir', 'Bordeaux', 'Ivoire'] }, { name: 'Taille', values: ['S', 'M', 'L', 'XL'] }], description: 'Robe longue en satin fluide, coupe drapée.' },
  { id: 'p2', name: 'Ensemble femme moderne', shopId: 'maison-fatou', category: 'Vêtements', price: 35000, image: P_IMG.dress, stock: 4, status: 'published', variants: [{ name: 'Couleur', values: ['Terracotta', 'Noir'] }, { name: 'Taille', values: ['S', 'M', 'L'] }], description: 'Ensemble deux pièces, top fluide et pantalon taille haute.' },
  { id: 'p3', name: 'Sac à main structuré', shopId: 'atelier-naya', category: 'Sacs & Maroquinerie', price: 24900, image: P_IMG.bag, stock: 8, status: 'published', variants: [{ name: 'Couleur', values: ['Camel', 'Noir', 'Cognac'] }], description: 'Sac structuré en cuir véritable, format moyen.' },
  { id: 'p4', name: 'Sérum hydratant visage', shopId: 'dakar-beauty', category: 'Beauté', price: 12500, image: P_IMG.serum, stock: 14, status: 'published', variants: [{ name: 'Contenance', values: ['30 ml', '50 ml'] }], description: 'Acide hyaluronique + vitamine E.' },
  { id: 'p5', name: 'Perruque Body Wave 22"', shopId: 'hair-studio-dakar', category: 'Cheveux', price: 85000, oldPrice: 95000, image: P_IMG.hair, stock: 4, status: 'published', variants: [{ name: 'Texture', values: ['Body Wave', 'Straight'] }, { name: 'Longueur', values: ['18"', '20"', '22"'] }, { name: 'Densité', values: ['150%', '180%', '200%'] }], description: 'Lace frontale, cheveux 100% naturels.' },
  { id: 'p6', name: 'Parfum femme 100ml', shopId: 'maison-senteur', category: 'Parfums & Senteurs', price: 32000, image: P_IMG.perfume, stock: 11, status: 'published', variants: [{ name: 'Volume', values: ['30ml', '50ml', '100ml'] }], description: 'Sillage floral chaleureux.' },
  { id: 'p7', name: 'Bracelet doré minimal', shopId: 'atelier-naya', category: 'Bijoux & Accessoires', price: 15000, oldPrice: 18000, image: P_IMG.jewelry, stock: 12, status: 'published', variants: [{ name: 'Finition', values: ['Doré', 'Argenté'] }], description: 'Bracelet fin plaqué or.' },
  { id: 'p8', name: 'Escarpins talons hauts', shopId: 'maison-fatou', category: 'Chaussures', price: 21000, image: P_IMG.shoe, stock: 3, status: 'published', variants: [{ name: 'Couleur', values: ['Nude', 'Noir'] }, { name: 'Taille', values: ['36', '37', '38', '39', '40'] }], description: 'Escarpins élégants, talon 8 cm.' },
  { id: 'p9', name: 'Palette maquillage nude', shopId: 'dakar-beauty', category: 'Beauté', price: 19500, image: P_IMG.makeup, stock: 7, status: 'pending', submittedDate: '2026-08-24', variants: [{ name: 'Teinte', values: ['Nude', 'Warm', 'Deep'] }], description: 'Palette 12 teintes, finis mats et satinés.' },
  { id: 'p10', name: 'Brume parfumée fleur de tiaré', shopId: 'maison-senteur', category: 'Parfums & Senteurs', price: 9500, image: P_IMG.perfume, stock: 18, status: 'pending', submittedDate: '2026-08-25', variants: [{ name: 'Volume', values: ['100ml'] }], description: 'Brume légère fleur de tiaré.' },
  { id: 'p11', name: 'Sandales en cuir minimales', shopId: 'atelier-naya', category: 'Chaussures', price: 16500, image: P_IMG.shoe, stock: 2, status: 'published', variants: [{ name: 'Couleur', values: ['Camel', 'Noir'] }, { name: 'Taille', values: ['36', '37', '38', '39'] }], description: 'Sandales fines en cuir.' },
  { id: 'p12', name: 'Crème anti-imperfections', shopId: 'dakar-beauty', category: 'Beauté', price: 14000, image: P_IMG.serum, stock: 0, status: 'out_of_stock', variants: [{ name: 'Contenance', values: ['40 ml'] }], description: 'Niacinamide, cible les imperfections.' },
  { id: 'p13', name: 'Collier plaqué or', shopId: 'atelier-naya', category: 'Bijoux & Accessoires', price: 22000, image: P_IMG.jewelry, stock: 6, status: 'changes_requested', submittedDate: '2026-08-22', variants: [{ name: 'Longueur', values: ['40 cm', '45 cm'] }], description: 'Collier fin plaqué or 18k.' },
  { id: 'p14', name: 'Mèches naturelles pré-tressées', shopId: 'hair-studio-dakar', category: 'Cheveux', price: 32000, image: P_IMG.hair, stock: 15, status: 'draft', variants: [{ name: 'Longueur', values: ['24"', '28"', '32"'] }], description: 'Mèches pré-tressées prêtes à poser.' },
  { id: 'p15', name: 'Encens oud premium', shopId: 'maison-senteur', category: 'Parfums & Senteurs', price: 7500, image: P_IMG.perfume, stock: 0, status: 'published', variants: [{ name: 'Quantité', values: ['50g', '100g'] }], description: 'Encens naturel au oud.' },
];
